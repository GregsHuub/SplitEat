...
<body>
<h1 class="noteAtTheTop"><sec:authentication property="principal.username"/>      : Share with you :)</h1>
<div class="limiter">
                ...
                <div class="table100-body js-pscroll">
                    <table>
                        ...
                        <tr class="row100 body">
                            ...
                            <td>
                                <form method="post" action="/api/order/addFriend/${dish.id}">
...
<form method="get" action="/api/order/orderReady">
    <button class="lastButton" type="submit" href="/api/order/orderReady">CHECKOUT!</button>
</form>
